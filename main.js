...
// Adicionar o grupo "Camadas Adicionadas"
var addedLayersGroup = {};

// Atualizar as opções de controle de layers
var options = {
...
// Adicionar o controle de layers customizado
map.layerControl = L.control.groupedLayers(basemaps, groupedOverlays, options).addTo(map);

// Adicionar um título e o container para as "Camadas Adicionadas"
...
var addedLayersTitle = document.createElement("strong");
addedLayersTitle.className = "title";
newLayerControl.appendChild(addedLayersTitle);

var addedLayersContainer = document.createElement("div");
addedLayersContainer.id = "addedLayers";
newLayerControl.appendChild(addedLayersContainer);
...
function addFileLayerControl() {
    ...
    control.loader.on('data:loaded', function (e) {
        var layer = e.layer;
        addedLayersGroup[e.filename] = layer; // Adicionar ao grupo de camadas adicionadas
        map.addLayer(layer);
        map.layerControl.addOverlay(layer, e.filename, "Camadas Adicionadas");
    });
